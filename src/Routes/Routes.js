    ...
    },
    {
        path: '*', element: <div><body>
            ...
            <div className='flex flex-col justify-center items-center text-2xl'>
                ...
                <h3>Page Not Found - lets take you <a href="https://resale-client-95e96.web.app/"><span className="underline underline-offset-1 text-sky-600 font-semibold">BACK</span></a></h3>
            </div>
        </body>
        </div>
    }
